...
function EstimateForm(props){
    ...
    const calcSubmit = (event) => { 
        ...
        plaintext = plaintext + "To confirm moving date " + jobDate + " , " + jobTime + " please send interact e-transfer deposit of $" + deposit.toFixed(2) * 1 + " to payment@runstarservices.com\n\n";
        ...
        <form className="estimateContainer" id='submitJobForm'>
            ...
            <div className='address'>
                ...
                <div className='modifiers'>
                    ...
                    <label htmlFor="ferry">Lunch</label>
